          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <select id="country" value={formData.country} onChange={handleChange} className="w-full border px-3 py-2 rounded">
                <option value="sri-lanka">select the country</option>
                <option value="Pakistan">Pakistan</option>
                <option value="UAE">Uae</option>
                <option value="india">India</option>
                <option value="saudi">Saudi Arbia</option>
            ...
            <div className="space-y-2">
              ...
              <select id="province" value={formData.province} onChange={handleChange} className="w-full border px-3 py-2 rounded">
                <option value="western">Select the Province</option>
                <option value="western">Sindh</option>
                <option value="western">Punjab</option>
                <option value="western">balochistan</option>
                <option value="western">Kpk</option>
              </select>
            </div>
